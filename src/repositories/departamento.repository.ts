...
> {
  ...
  public readonly cuidades: HasManyRepositoryFactory<Ciudad, typeof Departamento.prototype.id>;
  ...
  constructor(
    ...
    this.cuidades = this.createHasManyRepositoryFactoryFor('cuidades', ciudadRepositoryGetter,);
    this.registerInclusionResolver('cuidades', this.cuidades.inclusionResolver);
